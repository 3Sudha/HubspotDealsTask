...
class SettingsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    clear(appId, appId2, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "clear", "appId");
            }
            if (appId2 === null || appId2 === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "clear", "appId2");
            }
    ...
    configure(appId, appId2, settingsChangeRequest, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "configure", "appId");
            }
            if (appId2 === null || appId2 === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "configure", "appId2");
            }
            if (settingsChangeRequest === null || settingsChangeRequest === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "configure", "settingsChangeRequest");
            }
            const localVarPath = '/webhooks/v3/{appId}/settings'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)))
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId2)));
            ...
            const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(settingsChangeRequest, "SettingsChangeRequest", ""), contentType);
    ...
    getAll(appId, appId2, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (appId === null || appId === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "getAll", "appId");
            }
            if (appId2 === null || appId2 === undefined) {
                throw new baseapi_1.RequiredError("SettingsApi", "getAll", "appId2");
            }
            const localVarPath = '/webhooks/v3/{appId}/settings'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)))
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId2)));
    ...
    configure(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "SettingsResponse", "");
                return body;
            }
            if (util_1.isCodeInRange("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
