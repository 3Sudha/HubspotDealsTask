...
export declare class PromisePipelineAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdAudit(objectType: string, pipelineId: string, _options?: Configuration): Promise<CollectionResponsePublicAuditInfoNoPaging>;
}
...
export declare class PromisePipelineStageAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdStagesStageIdAudit(objectType: string, stageId: string, _options?: Configuration): Promise<CollectionResponsePublicAuditInfoNoPaging>;
}
...
export declare class PromisePipelineStagesApi {
    ...
    getAll(objectType: string, pipelineId: string, archived?: boolean, _options?: Configuration): Promise<CollectionResponsePipelineStageNoPaging>;
    getById(objectType: string, pipelineId: string, stageId: string, archived?: boolean, _options?: Configuration): Promise<PipelineStage>;
    ...
    update(objectType: string, pipelineId: string, stageId: string, pipelineStagePatchInput: PipelineStagePatchInput, archived?: boolean, _options?: Configuration): Promise<PipelineStage>;
}
...
export declare class PromisePipelinesApi {
    ...
    getAll(objectType: string, archived?: boolean, _options?: Configuration): Promise<CollectionResponsePipelineNoPaging>;
    getById(objectType: string, pipelineId: string, archived?: boolean, _options?: Configuration): Promise<Pipeline>;
    ...
    update(objectType: string, pipelineId: string, pipelinePatchInput: PipelinePatchInput, archived?: boolean, validateReferencesBeforeDelete?: boolean, _options?: Configuration): Promise<Pipeline>;
}
