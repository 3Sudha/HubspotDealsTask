...
class ObservableAssociationsApi {
    ...
    archive(ticketId, toObjectType, toObjectId, associationType, _options) {
    ...
    create(ticketId, toObjectType, toObjectId, associationType, _options) {
    ...
    getAll(ticketId, toObjectType, after, limit, _options) {
...
class ObservableBasicApi {
    ...
    getById(ticketId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const requestContextPromise = this.requestFactory.getById(ticketId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
