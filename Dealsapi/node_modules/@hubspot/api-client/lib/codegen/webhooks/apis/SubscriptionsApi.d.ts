...
export declare class SubscriptionsApiRequestFactory extends BaseAPIRequestFactory {
    archive(subscriptionId: number, appId: number, appId2: number, _options?: Configuration): Promise<RequestContext>;
    create(appId: number, appId2: number, subscriptionCreateRequest: SubscriptionCreateRequest, _options?: Configuration): Promise<RequestContext>;
    getAll(appId: number, appId2: number, _options?: Configuration): Promise<RequestContext>;
    getById(subscriptionId: number, appId: number, appId2: number, _options?: Configuration): Promise<RequestContext>;
    update(subscriptionId: number, appId: number, appId2: number, subscriptionPatchRequest: SubscriptionPatchRequest, _options?: Configuration): Promise<RequestContext>;
    updateBatch(appId: number, appId2: number, batchInputSubscriptionBatchUpdateRequest: BatchInputSubscriptionBatchUpdateRequest, _options?: Configuration): Promise<RequestContext>;
}
