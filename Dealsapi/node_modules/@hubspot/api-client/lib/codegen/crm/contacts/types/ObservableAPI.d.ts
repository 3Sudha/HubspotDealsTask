...
export declare class ObservableAssociationsApi {
    ...
    archive(contactId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void>;
    create(contactId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    getAll(contactId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging>;
}
...
export declare class ObservableBasicApi {
    ...
    archive(contactId: string, _options?: Configuration): Observable<void>;
    create(simplePublicObjectInput: SimplePublicObjectInput, _options?: Configuration): Observable<SimplePublicObject>;
    getById(contactId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    ...
    update(contactId: string, simplePublicObjectInput: SimplePublicObjectInput, _options?: Configuration): Observable<SimplePublicObject>;
}
...
export declare class ObservableGDPRApi {
    ...
    postCrmV3ObjectsContactsGdprDelete(publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Observable<void>;
}
