...
export interface GDPRApiPostCrmV3ObjectsContactsGdprDeleteRequest {
...
export declare class ObjectGDPRApi {
    ...
    postCrmV3ObjectsContactsGdprDelete(param: GDPRApiPostCrmV3ObjectsContactsGdprDeleteRequest, options?: Configuration): Promise<void>;
}
