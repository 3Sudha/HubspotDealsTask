...
class ObservablePipelineAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdAudit(objectType, pipelineId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getCrmV3PipelinesObjectTypePipelineIdAudit(rsp)));
        }));
    }
}
...
class ObservablePipelineStageAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdStagesStageIdAudit(objectType, stageId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getCrmV3PipelinesObjectTypePipelineIdStagesStageIdAudit(rsp)));
        }));
    }
}
...
class ObservablePipelineStagesApi {
    ...
    getAll(objectType, pipelineId, archived, _options) {
    ...
    getById(objectType, pipelineId, stageId, archived, _options) {
    ...
    replace(objectType, pipelineId, stageId, pipelineStageInput, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.replace(rsp)));
        }));
    }
    update(objectType, pipelineId, stageId, pipelineStagePatchInput, archived, _options) {
