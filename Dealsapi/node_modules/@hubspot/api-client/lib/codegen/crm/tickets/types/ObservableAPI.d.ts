...
export declare class ObservableAssociationsApi {
    ...
    archive(ticketId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void>;
    create(ticketId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    getAll(ticketId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging>;
}
...
export declare class ObservableBasicApi {
    ...
    archive(ticketId: string, _options?: Configuration): Observable<void>;
    create(simplePublicObjectInput: SimplePublicObjectInput, _options?: Configuration): Observable<SimplePublicObject>;
    getById(ticketId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, idProperty?: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    ...
    update(ticketId: string, simplePublicObjectInput: SimplePublicObjectInput, idProperty?: string, _options?: Configuration): Observable<SimplePublicObject>;
}
