...
export declare class ObservablePipelineAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdAudit(objectType: string, pipelineId: string, _options?: Configuration): Observable<CollectionResponsePublicAuditInfoNoPaging>;
}
...
export declare class ObservablePipelineStageAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdStagesStageIdAudit(objectType: string, stageId: string, _options?: Configuration): Observable<CollectionResponsePublicAuditInfoNoPaging>;
}
...
export declare class ObservablePipelineStagesApi {
    ...
    getAll(objectType: string, pipelineId: string, archived?: boolean, _options?: Configuration): Observable<CollectionResponsePipelineStageNoPaging>;
    getById(objectType: string, pipelineId: string, stageId: string, archived?: boolean, _options?: Configuration): Observable<PipelineStage>;
    ...
    update(objectType: string, pipelineId: string, stageId: string, pipelineStagePatchInput: PipelineStagePatchInput, archived?: boolean, _options?: Configuration): Observable<PipelineStage>;
}
...
export declare class ObservablePipelinesApi {
    ...
    getAll(objectType: string, archived?: boolean, _options?: Configuration): Observable<CollectionResponsePipelineNoPaging>;
    getById(objectType: string, pipelineId: string, archived?: boolean, _options?: Configuration): Observable<Pipeline>;
    ...
    update(objectType: string, pipelineId: string, pipelinePatchInput: PipelinePatchInput, archived?: boolean, validateReferencesBeforeDelete?: boolean, _options?: Configuration): Observable<Pipeline>;
}
