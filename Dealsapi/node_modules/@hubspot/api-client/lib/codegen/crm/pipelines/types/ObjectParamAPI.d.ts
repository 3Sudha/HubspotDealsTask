...
export declare class ObjectPipelineAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdAudit(param: PipelineAuditsApiGetCrmV3PipelinesObjectTypePipelineIdAuditRequest, options?: Configuration): Promise<CollectionResponsePublicAuditInfoNoPaging>;
}
...
export declare class ObjectPipelineStageAuditsApi {
    ...
    getCrmV3PipelinesObjectTypePipelineIdStagesStageIdAudit(param: PipelineStageAuditsApiGetCrmV3PipelinesObjectTypePipelineIdStagesStageIdAuditRequest, options?: Configuration): Promise<CollectionResponsePublicAuditInfoNoPaging>;
}
