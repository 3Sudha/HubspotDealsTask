...
exports.PromiseSearchApi = exports.PromiseBatchApi = exports.PromiseBasicApi = exports.PromiseAssociationsApi = void 0;
...
class PromiseAssociationsApi {
    ...
    archive(lineItemId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.archive(lineItemId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
    create(lineItemId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.create(lineItemId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
    getAll(lineItemId, toObjectType, after, limit, _options) {
        const result = this.api.getAll(lineItemId, toObjectType, after, limit, _options);
        return result.toPromise();
    }
}
...
class PromiseBasicApi {
    ...
    archive(lineItemId, _options) {
        const result = this.api.archive(lineItemId, _options);
        return result.toPromise();
    }
    ...
    getById(lineItemId, properties, propertiesWithHistory, associations, archived, idProperty, _options) {
        const result = this.api.getById(lineItemId, properties, propertiesWithHistory, associations, archived, idProperty, _options);
        return result.toPromise();
    }
    ...
    update(lineItemId, simplePublicObjectInput, idProperty, _options) {
        const result = this.api.update(lineItemId, simplePublicObjectInput, idProperty, _options);
        return result.toPromise();
    }
}
