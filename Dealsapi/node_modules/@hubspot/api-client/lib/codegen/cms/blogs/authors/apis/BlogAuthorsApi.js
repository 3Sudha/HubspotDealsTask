...
exports.BlogAuthorsApiResponseProcessor = exports.BlogAuthorsApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class BlogAuthorsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectId, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "archive", "objectId");
            }
    ...
    archiveBatch(batchInputString, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "archiveBatch", "batchInputString");
            }
    ...
    create(blogAuthor, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (blogAuthor === null || blogAuthor === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "create", "blogAuthor");
            }
    ...
    createBatch(batchInputBlogAuthor, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputBlogAuthor === null || batchInputBlogAuthor === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "createBatch", "batchInputBlogAuthor");
            }
    ...
    getById(objectId, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "getById", "objectId");
            }
            const localVarPath = '/cms/v3/blogs/authors/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
    ...
    postCmsV3BlogsAuthorsMultiLanguageAttachToLangGroup(attachToLangPrimaryRequestVNext, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (attachToLangPrimaryRequestVNext === null || attachToLangPrimaryRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "postCmsV3BlogsAuthorsMultiLanguageAttachToLangGroup", "attachToLangPrimaryRequestVNext");
            }
    ...
    postCmsV3BlogsAuthorsMultiLanguageCreateLanguageVariation(blogAuthorCloneRequestVNext, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (blogAuthorCloneRequestVNext === null || blogAuthorCloneRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "postCmsV3BlogsAuthorsMultiLanguageCreateLanguageVariation", "blogAuthorCloneRequestVNext");
            }
    ...
    postCmsV3BlogsAuthorsMultiLanguageDetachFromLangGroup(detachFromLangGroupRequestVNext, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (detachFromLangGroupRequestVNext === null || detachFromLangGroupRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "postCmsV3BlogsAuthorsMultiLanguageDetachFromLangGroup", "detachFromLangGroupRequestVNext");
            }
    ...
    postCmsV3BlogsAuthorsMultiLanguageUpdateLanguages(updateLanguagesRequestVNext, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (updateLanguagesRequestVNext === null || updateLanguagesRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "postCmsV3BlogsAuthorsMultiLanguageUpdateLanguages", "updateLanguagesRequestVNext");
            }
    ...
    putCmsV3BlogsAuthorsMultiLanguageSetNewLangPrimary(setNewLanguagePrimaryRequestVNext, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (setNewLanguagePrimaryRequestVNext === null || setNewLanguagePrimaryRequestVNext === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "putCmsV3BlogsAuthorsMultiLanguageSetNewLangPrimary", "setNewLanguagePrimaryRequestVNext");
            }
    ...
    readBatch(batchInputString, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (batchInputString === null || batchInputString === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "readBatch", "batchInputString");
            }
    ...
    update(objectId, blogAuthor, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectId === null || objectId === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "update", "objectId");
            }
            if (blogAuthor === null || blogAuthor === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "update", "blogAuthor");
            }
            const localVarPath = '/cms/v3/blogs/authors/{objectId}'
                .replace('{' + 'objectId' + '}', encodeURIComponent(String(objectId)));
    ...
    updateBatch(batchInputJsonNode, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (batchInputJsonNode === null || batchInputJsonNode === undefined) {
                throw new baseapi_1.RequiredError("BlogAuthorsApi", "updateBatch", "batchInputJsonNode");
            }
...
exports.BlogAuthorsApiRequestFactory = BlogAuthorsApiRequestFactory;
class BlogAuthorsApiResponseProcessor {
    archive(response) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createBatch(response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (util_1.isCodeInRange("207", response.httpStatusCode)) {
    ...
    postCmsV3BlogsAuthorsMultiLanguageAttachToLangGroup(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    postCmsV3BlogsAuthorsMultiLanguageCreateLanguageVariation(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("200", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "BlogAuthor", "");
    ...
    postCmsV3BlogsAuthorsMultiLanguageDetachFromLangGroup(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    postCmsV3BlogsAuthorsMultiLanguageUpdateLanguages(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("0", response.httpStatusCode)) {
                const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(yield response.body.text(), contentType), "Error", "");
    ...
    putCmsV3BlogsAuthorsMultiLanguageSetNewLangPrimary(response) {
        return __awaiter(this, void 0, void 0, function* () {
            const contentType = ObjectSerializer_1.ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            if (util_1.isCodeInRange("204", response.httpStatusCode)) {
                return;
...
exports.BlogAuthorsApiResponseProcessor = BlogAuthorsApiResponseProcessor;
//# sourceMappingURL=BlogAuthorsApi.js.map