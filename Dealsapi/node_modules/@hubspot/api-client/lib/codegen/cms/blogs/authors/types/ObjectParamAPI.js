...
class ObjectBlogAuthorsApi {
    ...
    postCmsV3BlogsAuthorsMultiLanguageAttachToLangGroup(param, options) {
    ...
    postCmsV3BlogsAuthorsMultiLanguageCreateLanguageVariation(param, options) {
    ...
    postCmsV3BlogsAuthorsMultiLanguageDetachFromLangGroup(param, options) {
    ...
    postCmsV3BlogsAuthorsMultiLanguageUpdateLanguages(param, options) {
        return this.api.postCmsV3BlogsAuthorsMultiLanguageUpdateLanguages(param.updateLanguagesRequestVNext, options).toPromise();
    }
    putCmsV3BlogsAuthorsMultiLanguageSetNewLangPrimary(param, options) {
