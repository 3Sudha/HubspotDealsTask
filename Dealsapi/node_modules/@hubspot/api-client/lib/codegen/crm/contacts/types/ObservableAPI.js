...
exports.ObservableSearchApi = exports.ObservableGDPRApi = exports.ObservableBatchApi = exports.ObservableBasicApi = exports.ObservableAssociationsApi = void 0;
const rxjsStub_1 = require("../rxjsStub");
const rxjsStub_2 = require("../rxjsStub");
const AssociationsApi_1 = require("../apis/AssociationsApi");
class ObservableAssociationsApi {
    ...
    archive(contactId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.archive(contactId, toObjectType, toObjectId, associationType, _options);
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.archive(rsp)));
        }));
    }
    create(contactId, toObjectType, toObjectId, associationType, _options) {
        const requestContextPromise = this.requestFactory.create(contactId, toObjectType, toObjectId, associationType, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
    ...
    getAll(contactId, toObjectType, after, limit, _options) {
        const requestContextPromise = this.requestFactory.getAll(contactId, toObjectType, after, limit, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getAll(rsp)));
        }));
    }
}
...
class ObservableBasicApi {
    ...
    archive(contactId, _options) {
        const requestContextPromise = this.requestFactory.archive(contactId, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
    ...
    getById(contactId, properties, propertiesWithHistory, associations, archived, _options) {
        const requestContextPromise = this.requestFactory.getById(contactId, properties, propertiesWithHistory, associations, archived, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getById(rsp)));
        }));
    }
    getPage(limit, after, properties, propertiesWithHistory, associations, archived, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getPage(rsp)));
        }));
    }
    update(contactId, simplePublicObjectInput, _options) {
        const requestContextPromise = this.requestFactory.update(contactId, simplePublicObjectInput, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
...
class ObservableBatchApi {
    ...
    read(batchReadInputSimplePublicObjectId, archived, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.read(rsp)));
        }));
    }
...
const GDPRApi_1 = require("../apis/GDPRApi");
class ObservableGDPRApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new GDPRApi_1.GDPRApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new GDPRApi_1.GDPRApiResponseProcessor();
    }
    postCrmV3ObjectsContactsGdprDelete(publicGdprDeleteInput, _options) {
        const requestContextPromise = this.requestFactory.postCrmV3ObjectsContactsGdprDelete(publicGdprDeleteInput, _options);
        let middlewarePreObservable = rxjsStub_1.from(requestContextPromise);
        for (let middleware of this.configuration.middleware) {
            middlewarePreObservable = middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => middleware.pre(ctx)));
        }
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.postCrmV3ObjectsContactsGdprDelete(rsp)));
        }));
    }
}
exports.ObservableGDPRApi = ObservableGDPRApi;
...
class ObservableSearchApi {
    ...
    doSearch(publicObjectSearchRequest, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.doSearch(rsp)));
        }));
    }
}
