...
const authUrl =
'https://app.hubspot.com/oauth/authorize?client_id=b37a27f6-91a5-403b-97ac-6dd69c6e4a42&redirect_uri=http://localhost:3000/oauth-callback&scope=crm.objects.deals.read%20crm.objects.deals.write';
...
app.get("/deals",async(req,res)=>{
  if (isAuthorized(req.sessionID)) {
     ...
     console.log(deals);
     res.render("deals", {newdeals: deals });
...
//Create Deals
app.get('/createdeals', async (req, res)=>{
  if(isAuthorized(req.sessionID))
  {
