...
exports.PipelinesApiResponseProcessor = exports.PipelinesApiRequestFactory = void 0;
const baseapi_1 = require("./baseapi");
const http_1 = require("../http/http");
const ObjectSerializer_1 = require("../models/ObjectSerializer");
const exception_1 = require("./exception");
const util_1 = require("../util");
class PipelinesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(objectType, pipelineId, validateReferencesBeforeDelete, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "archive", "objectType");
            }
            if (pipelineId === null || pipelineId === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "archive", "pipelineId");
            }
    ...
    create(objectType, pipelineInput, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "create", "objectType");
            }
            if (pipelineInput === null || pipelineInput === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "create", "pipelineInput");
            }
    ...
    getAll(objectType, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "getAll", "objectType");
            }
            const localVarPath = '/crm/v3/pipelines/{objectType}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)));
    ...
    getById(objectType, pipelineId, archived, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "getById", "objectType");
            }
            if (pipelineId === null || pipelineId === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "getById", "pipelineId");
            }
            const localVarPath = '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
    ...
    replace(objectType, pipelineId, pipelineInput, validateReferencesBeforeDelete, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "replace", "objectType");
            }
            if (pipelineId === null || pipelineId === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "replace", "pipelineId");
            }
            if (pipelineInput === null || pipelineInput === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "replace", "pipelineInput");
            }
            const localVarPath = '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
    ...
    update(objectType, pipelineId, pipelinePatchInput, archived, validateReferencesBeforeDelete, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            let _config = _options || this.configuration;
            if (objectType === null || objectType === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "update", "objectType");
            }
            if (pipelineId === null || pipelineId === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "update", "pipelineId");
            }
            if (pipelinePatchInput === null || pipelinePatchInput === undefined) {
                throw new baseapi_1.RequiredError("PipelinesApi", "update", "pipelinePatchInput");
            }
            const localVarPath = '/crm/v3/pipelines/{objectType}/{pipelineId}'
                .replace('{' + 'objectType' + '}', encodeURIComponent(String(objectType)))
                .replace('{' + 'pipelineId' + '}', encodeURIComponent(String(pipelineId)));
...
class PipelinesApiResponseProcessor {
    archive(response) {
        return __awaiter(this, void 0, void 0, function* () {
