...
class ObservableGDPRApi {
    ...
    postCrmV3ObjectsObjectTypeGdprDelete(objectType, publicGdprDeleteInput, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.postCrmV3ObjectsObjectTypeGdprDelete(rsp)));
        }));
    }
}
