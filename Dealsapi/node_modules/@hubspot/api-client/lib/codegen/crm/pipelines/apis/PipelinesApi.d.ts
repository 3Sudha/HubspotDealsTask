...
export declare class PipelinesApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getById(objectType: string, pipelineId: string, archived?: boolean, _options?: Configuration): Promise<RequestContext>;
    ...
    update(objectType: string, pipelineId: string, pipelinePatchInput: PipelinePatchInput, archived?: boolean, validateReferencesBeforeDelete?: boolean, _options?: Configuration): Promise<RequestContext>;
}
