...
export declare class SettingsApiRequestFactory extends BaseAPIRequestFactory {
    clear(appId: number, appId2: number, _options?: Configuration): Promise<RequestContext>;
    configure(appId: number, appId2: number, settingsChangeRequest: SettingsChangeRequest, _options?: Configuration): Promise<RequestContext>;
