...
export declare class PromiseAssociationsApi {
    ...
    archive(contactId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<void>;
    create(contactId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Promise<SimplePublicObjectWithAssociations>;
    getAll(contactId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Promise<CollectionResponseAssociatedIdForwardPaging>;
}
...
export declare class PromiseBasicApi {
    ...
    archive(contactId: string, _options?: Configuration): Promise<void>;
    create(simplePublicObjectInput: SimplePublicObjectInput, _options?: Configuration): Promise<SimplePublicObject>;
    getById(contactId: string, properties?: Array<string>, propertiesWithHistory?: Array<string>, associations?: Array<string>, archived?: boolean, _options?: Configuration): Promise<SimplePublicObjectWithAssociations>;
    ...
    update(contactId: string, simplePublicObjectInput: SimplePublicObjectInput, _options?: Configuration): Promise<SimplePublicObject>;
}
...
export declare class PromiseGDPRApi {
    ...
    postCrmV3ObjectsContactsGdprDelete(publicGdprDeleteInput: PublicGdprDeleteInput, _options?: Configuration): Promise<void>;
}
