...
class ObjectAssociationsApi {
    ...
    archive(param, options) {
        return this.api.archive(param.productId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.productId, param.toObjectType, param.toObjectId, param.associationType, options).toPromise();
    }
    getAll(param, options) {
        return this.api.getAll(param.productId, param.toObjectType, param.after, param.limit, options).toPromise();
    }
}
...
class ObjectBasicApi {
    ...
    archive(param, options) {
        return this.api.archive(param.productId, options).toPromise();
    }
    create(param, options) {
        return this.api.create(param.simplePublicObjectInput, options).toPromise();
    }
    getById(param, options) {
        return this.api.getById(param.productId, param.properties, param.propertiesWithHistory, param.associations, param.archived, param.idProperty, options).toPromise();
    }
    ...
    update(param, options) {
        return this.api.update(param.productId, param.simplePublicObjectInput, param.idProperty, options).toPromise();
    }
}
