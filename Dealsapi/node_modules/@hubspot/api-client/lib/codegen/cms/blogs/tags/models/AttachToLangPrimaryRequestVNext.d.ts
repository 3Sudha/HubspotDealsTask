export declare class AttachToLangPrimaryRequestVNext {
    'id': string;
    'language': AttachToLangPrimaryRequestVNextLanguageEnum;
    'primaryId': string;
    'primaryLanguage'?: AttachToLangPrimaryRequestVNextPrimaryLanguageEnum;
